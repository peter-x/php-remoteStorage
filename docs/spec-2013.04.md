...
In the "storage first" scenario all applications need to be registered in the
OAuth server. This can be done automatically be subscribing the server to a 
trusted "app store" that provides a list of verified applications. 

The format of this manifest is shown below. It is using the Chrome Web Store 
format:
    ...
    [
        {
            "app": {
                "launch": {
                    "web_url": "http://todomvc.example.org/"
                }, 
                "urls": [
                    "http://todomvc.example.org/"
                ]
            }, 
            "description": "Manage your TODO list", 
            "icons": {
                "128": "http://todomvc.example.org/icon_x128.png"
            }, 
            "key": "todomvc.example.org", 
            "name": "TodoMVC", 
            "permissions": [
                "tasks:rw"
            ], 
